...
const STRINGS = {
  pl: {
    ...
    autoClickHead: '🤖 <b>Auto-klikacz</b> — obejrzyj reklamę, aby asteroida wydobywała się sama przez {0} s',
    autoClickActive: '🤖 Auto-klikacz aktywny ({0}s)', autoClickWatch: '🎬 Obejrzyj reklamę → Auto-klikacz {0}s',
    autoClickToast: '🤖 Auto-klikacz aktywny przez {0} s!',
    adTitle: '🎬 Reklama', adBody: 'Tu w wersji na Google Play wyświetli się prawdziwa reklama z nagrodą (AdMob).<br>W przeglądarce — symulacja.',
    adWait: 'Poczekaj {0} s…', adReady: '✅ Odbierz nagrodę', adFailed: '📵 Reklama niedostępna, spróbuj później.',
    ...
    gpgHead: '🎮 <b>Google Play Games</b>', gpgSignedIn: '✅ Zalogowano — osiągnięcia i ranking są synchronizowane',
    gpgSignIn: '🎮 Zaloguj się przez Google Play', gpgSignInOk: '✅ Zalogowano przez Google Play!',
    gpgSignInFail: '⚠️ Logowanie nieudane. Spróbuj ponownie.',
    gpgShowAchv: '🏆 Zobacz osiągnięcia (Google Play)', gpgShowBoard: '📊 Zobacz ranking (Google Play)',
    gpgRestoreTitle: '☁️ Znaleziono zapis w chmurze', gpgRestoreBody: 'Google Play ma zapisany postęp z innego urządzenia ({0} 💎 wydobyte łącznie). Przywrócić go?',
    gpgRestoreYes: 'Tak, przywróć', gpgRestoreNo: 'Nie, zostań przy tym urządzeniu', gpgRestoreDone: '☁️ Postęp przywrócony z chmury!',
  ...
  en: {
    ...
    autoClickHead: '🤖 <b>Auto-clicker</b> — watch an ad to make the asteroid mine itself for {0} s',
    autoClickActive: '🤖 Auto-clicker active ({0}s)', autoClickWatch: '🎬 Watch an ad → Auto-clicker {0}s',
    autoClickToast: '🤖 Auto-clicker active for {0} s!',
    adTitle: '🎬 Ad', adBody: 'On Google Play this will show a real rewarded ad (AdMob).<br>In the browser — simulation.',
    adWait: 'Wait {0} s…', adReady: '✅ Claim reward', adFailed: '📵 Ad unavailable, try again later.',
    ...
    gpgHead: '🎮 <b>Google Play Games</b>', gpgSignedIn: '✅ Signed in — achievements and leaderboard are synced',
    gpgSignIn: '🎮 Sign in with Google Play', gpgSignInOk: '✅ Signed in with Google Play!',
    gpgSignInFail: '⚠️ Sign-in failed. Try again.',
    gpgShowAchv: '🏆 View achievements (Google Play)', gpgShowBoard: '📊 View leaderboard (Google Play)',
    gpgRestoreTitle: '☁️ Cloud save found', gpgRestoreBody: 'Google Play has saved progress from another device ({0} 💎 mined total). Restore it?',
    gpgRestoreYes: 'Yes, restore', gpgRestoreNo: 'No, keep this device', gpgRestoreDone: '☁️ Progress restored from the cloud!',
